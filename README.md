...
- **Audio Effects:** Listen to the cries of every Pokémon, alongside retro UI click sounds.
- **Keyboard, Mouse & Touch Support:** Fully navigable using traditional emulator keybinds, modern mouse interactions, and mobile touch gestures.
...
### Touch
- **Swipe Up / Down:** Navigate through the Pokémon list or cycle to the next/previous Pokémon in the details view.
- **Tap:** Select a Pokémon from the list or interact with menu options.
